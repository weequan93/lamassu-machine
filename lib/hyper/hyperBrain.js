...
HyperBrain.prototype.atmConfirmDepositLogic = function () {
    ...
    const rData = {
        ...
        price: (self.tx.fiat.toNumber()/dAmount),
    ...
    this.atmTrader.addAtmOrderSell(
        {
            ...
            price: (data.fiat_amount /dAmount),
...
HyperBrain.prototype.saveHyperOrderTx = function (order, dispenserInfo, submittedOn = "") {
    ...
    let newLayout = {
        ...
        chain_name: chain,
        digital_amount: (order.digital_amount),
...
HyperBrain.prototype.saveHyperTx = function (order, submittedOn = "") {
    ...
    newLayout.digital_amount = ((this.tx.fiat.toNumber() / coin.price * (1 - (coin.buyFee + coin.buyFeeRate))))
