        ...
        .addAtmOrderBuy(
            {
                ...
                digital_amount: (self.tx.fiat.toNumber() / coin.price * (100 - (coin.buyFee + coin.buyFeeRate)) / 100).toString(), // 数字货币数量
    ...
    let newLayout = {
        ...
        for (let count = 0; count < dispenserInfo.length; count++) {
            ...
            if(bill.provisioned > 0){
                for(let provisioned1 = 0; provisioned1<provisioned;provisioned1++ ){
