...
HyperBrain.prototype.heartBeat = async function () {
    ...
    const dataSend = { 
        latency: networkHeartBeat[0].averageResponseTime,
        network_speed: downloadSpeed[0].speed,
        packet_loss: networkHeartBeat[0].packetLoss,
        device_status: 0
     }
