...
HyperBrain.prototype.atmConfirmDepositLogic = function () {
    ...
    const rData = {
        ...
        digital_amount: decimalN.convert((self.tx.fiat.toNumber() / self.atmTrader.tx.coinprice * (1 - (coin.buyFee + coin.buyFeeRate)))),
        ...
        price: self.atmTrader.tx.coinprice * (1 - (coin.buyFee + coin.buyFeeRate)),
    ...
    this.atmTrader.addAtmOrderSell(
        {
            ...
            digital_amount: decimalN.convert((data.fiat_amount / self.atmTrader.tx.coinprice * (1 + (coin.sellFee + coin.sellFeeRate)))),
            //digitalAmount.substring(0, digitalAmount.length -1), // 数字货币数量
            fiat_currency: self.atmTrader.config.fiatCurrency, // 法币名称
            coin_id: chain.id,
