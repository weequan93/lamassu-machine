    ...
    HyperBrain.prototype.processAction = function processAction(action, stateMachine) {
        ...
        switch (action) {
            ...
            case 'updateBillLogic':
                ...
                break
            case 'atmConfirmDepositDetailLogic':
                this.atmConfirmDepositDetailLogic()
                break
            
            case 'atmConfirmDepositInformationLogic':
                this.atmConfirmDepositInformationLogic()
                break
