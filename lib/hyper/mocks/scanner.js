...
function atmStartScanQR  (callback) {
  //callback(null, "20220831073558830453")
  // callback(null, "20220817155139145980")
  // callback(null, "0xf4E70DE75FE91A6A036058e2b1780fadA9f526Bd") //
  //callback(null, "0xf4E70DE75FE91A6A036058e2b1780fadA9f526Bd") // eth usdt
  //callback(null, "TYZ5sx4Bu4KR8yR9Tgvp5ErmAg3qv3TMJu") // trx

  // TQs6urUV3niYqpJmVKYH7tXi97Ez3XGzrb trx tester
  if (alreadyFire <3){
    console.debug(">>>>>>ommandLine.mockScanValue", commandLine.mockScanValue)
    if (commandLine.mockScanValue) {
      alreadyFire++
      callback(null, commandLine.mockScanValue)
    }
  }
