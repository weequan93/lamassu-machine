...
async function stopService (){
  ...
  let command = 'supervisorctl stop hyper-machine-browser'
  await new Promise((resolve, reject) => {
    cp.execFile(command, [], {}, function (msg) {
      console.log(msg)
      return resolve()
  ...
  command = 'supervisorctl stop hyper-browser'
  await new Promise((resolve, reject) => {
    cp.execFile(command, [], {}, function (msg) {
      console.log(msg)
      return resolve()
...
async function startService(){
  let command = 'supervisorctl start hyper-machine-browser'
  await new Promise((resolve, reject) => {
    cp.execFile(command, [], {}, function (msg) {
      console.log(msg)
      return resolve()
  ...
  command = 'supervisorctl start hyper-browser'
  await new Promise((resolve, reject) => {
    cp.execFile(command, [], {}, function (msg) {
      console.log(msg)
      return resolve()
