...
const dictionary = [
    ...
    { short: "atmLessThanDepositKYCLimit", msg: "存入低于限额", code: "90004" },

    { short: "atmCreateOrderFailNoOrderNo", msg: "创建订单失败-无订单号", code: "90004" },
    { short: "atmCreateOrderFail", msg: "创建订单失败", code: "90005" },
    { short: "atmCashBoxError", msg: "钱箱异常", code: "90006" },

    { short: "atmScanInvalidAddress", msg: "地址无效", code: "99999999" },
