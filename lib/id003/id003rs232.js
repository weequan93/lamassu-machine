...
Id003Rs232.prototype.open = function open (cb) {
  var self = this
  console.log("=== Id003Rs232", this.config)
...
Id003Rs232.prototype._escrow = function _escrow (rawData) {
  var fiatCode = rawData[0]
  var denomination = this.denominations[fiatCode]
  return {denomination: denomination, code: fiatCode}
}
...
Id003Rs232.prototype._denominations = function _denominations (rawData) {
  // TODO: add in fiatCode tables to support multiple currencies at once
