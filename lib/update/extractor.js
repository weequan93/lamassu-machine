...
Extractor.prototype._extractTree = function _extractTree (cb) {
  const self= this
  console.log("_extractTree", this.filePath, this.rootPath)
  cp.exec("mv "+this.filePath+" " + self.rootPath+"latest.zip", null, function(){
    cp.exec("unzip "+this.filePath+" " + self.rootPath+"latest.zip", null, cb)
  })
