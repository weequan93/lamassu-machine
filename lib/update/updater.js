...
function fetchVersion (config) {
  ...
  console.log("=== fetchVersion packageJson",packageJson)
...
Updater.prototype._init = function _init () {
  ...
  var packagePath = this.config.updater.downloadDir + '/latest.tar'
...
Updater.prototype._preUpdate = function _preUpdate () {
  ...
  var req = https.request(options, function (res) {
    ...
    console.log("_preUpdate", serverVersion, this.version )
...
Updater.prototype._update = function _update () {
  this._preUpdate()
  if (this._readyForDownload()) this._download("/release/latest.tar")
}
